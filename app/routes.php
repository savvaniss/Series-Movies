...
$app->group('', function (){
    ...
    $this->get('/series',  'SeriesController:getSeries')->setName('series');
    $this->get('/series/{slug}', 'SeriesController:getSeriesPost')->setName('series.post');
...
$app->group('', function (){
    ...
    $this->get('/create', 'SeriesController:getCreateSeries')->setName('series.create');
    $this->post('/create', 'SeriesController:postCreateSeries');
